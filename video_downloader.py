...
def process_videos_for_shorts(video_paths, output_filename="y_short.mp4", max_duration=60):
    """
...
if __name__ == "__main__":
    ...
    final_video_path = process_videos_for_shorts(downloaded_video_paths, output_short_filename)
